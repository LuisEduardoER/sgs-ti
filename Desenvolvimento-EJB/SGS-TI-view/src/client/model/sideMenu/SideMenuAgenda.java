...
public class SideMenuAgenda implements SideMenu {
	// Debug
	...
	public JPanel inicializaComponentes() {
		if(DEBUG)
			System.out.println("Inicializando SideMenuAgenda...");
	...
	private JPanel carregarSubMenuConteudos(){
		...
		JButton btListarClientes = new JButton("Listar Agenda");
		btListarClientes.setPreferredSize(new Dimension(160,25));
		btListarClientes.setEnabled(true);
		btListarClientes.setActionCommand(ClientConstraint.LISTAR_AGENDA);
